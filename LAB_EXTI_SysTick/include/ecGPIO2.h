...
#define DIGIT_OUT0 PA_7   //Find LED Port&Pin and Fill the blank	
#define DIGIT_OUT1 PB_6   //Find LED Port&Pin and Fill the blank	
#define DIGIT_OUT2 PC_7   //Find LED Port&Pin and Fill the blank	
#define DIGIT_OUT3 PA_9   //Find LED Port&Pin and Fill the blank	
#define BUTTON_PIN PC_13//Find BTN Port&Pin and Fill the blank

#define CLKSOURCE 0x02
